...
<main>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="sectionContent col-lg order-lg-1">
          <span class="pretitle">Discover our locations</span>
          <h2>Our offices</h2>
  ...
  <section class="team sectionNoSpaceUp">
    <div class="container">
      <div class="row">
        <p>There where 7 of us</p>
        <?php echo file_get_contents('asset/images/svg/sevenDots.svg'); ?>
      </div>
      <div class="row">
        <div class="col-lg-6">
          <span class="pretitle">Your trusted logistics partners</span>
          <h2>Meet our team</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="sectionContent col-lg-6">
          <span class="pretitle">A career with Fresh Ways</span>
