    ...
    <div class="container">
      <div class="row">
        <div class="sectionImage col-lg order-lg-2 d-flex justify-content-center align-items-center">
          <img style="width: 40%;" src="asset/images/svg/integratedServices.svg" alt="Our offices" />
        </div>
        <div class="sectionContent col-lg order-lg-1">
          <h1 class="text-big mb-4">Our services</h1>
      ...
      <div class="row pt-5">
        ...
        <div class="col-md">
          ...
          <h2 class="text-large mb-4">Book the services</h2>
          <ul>
            <li>📦 picking up the goods</li>
            <li>🧩 logistics management</li>
            <li>🌍 customs documentation</li>
            <li>🚛 transport organisation</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="transportServices">
    <div class="container">
      ...
      <div class="row justify-content-center align-items-center gap-5 py-5">
        ...
        <div class="col-auto circular d-flex flex-column justify-content-center align-items-center">
          <?php echo file_get_contents('asset/images/svg/chillIcon.svg'); ?>
          <p class="bold">Chilled</p>
        </div>
        <div class="col-auto circular d-flex flex-column justify-content-center align-items-center">
          <?php echo file_get_contents('asset/images/svg/ambientIcon.svg'); ?>
        ...
        <div class="sectionContent col-lg order-lg-2">
          ...
          <div class="flags p-4 rounded mt-4">
            <ul class="p-0 m-0 d-flex flex-wrap justify-content-center align-items-center gap-3">
              ...
              <li><?php echo file_get_contents('asset/images/svg/flags/es.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/it.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/be.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/de.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/nl.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/ie.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/pt.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/lt.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/dk.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/se.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/at.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/lu.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/ro.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/pl.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/ee.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/fi.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/mt.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/gr.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/lv.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/lt.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/hu.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/cz.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/si.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/bg.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/hr.svg'); ?></li>
              <li><?php echo file_get_contents('asset/images/svg/flags/sk.svg'); ?></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="row plusInfo justify-content-between align-items-center gap-3 py-5">
        ...
        <div class="col-auto d-flex flex-column justify-content-between align-items-center">
          <?php echo file_get_contents('asset/images/svg/transportIcon2.svg'); ?>
          <p class="bold mt-2">Integrazione software</p>
        </div>
        <div class="col-auto d-flex flex-column justify-content-between align-items-center">
          <?php echo file_get_contents('asset/images/svg/transportIcon3.svg'); ?>
          <p class="bold mt-2">Servizio personalizzato</p>
        </div>
        <div class="col-auto d-flex flex-column justify-content-between align-items-center">
          <?php echo file_get_contents('asset/images/svg/transportIcon4.svg'); ?>
          <p class="bold mt-2">Gestione della logistica integrata</p>
        </div>
      </div>
      <div class="row pt-5">
