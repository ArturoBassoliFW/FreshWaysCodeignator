...
<main>
    ...
    <section class="servicesOffered bg-menoventi100">
        <div class="container">
            <div class="row">
                <div class="col">
                    <span class="pretitle text-small">Discover our services</span>
                    <h2 class="text-big mb-4">Services we offer</h2>
                </div>
            </div>
            <div class="row gap-3">
                <div class="card col-lg bg-ambiente1000">
                    <div class="card-body">
                        <div class="cardTitle d-flex align-items-center gap-1 mb-2">
                            <?php echo file_get_contents('asset/images/svg/logisticIcon.svg'); ?>
                            <h3 class="cl-light text-large">Logistics</h3>
                        </div>
                ...
                <div class="card col-lg bg-piuquattro1000">
                    <div class="card-body">
                        <div class="cardTitle d-flex align-items-center gap-1 mb-2">
                            ...
                            <h3 class="cl-light text-large">Customs</h3>
                        </div>
                ...
                <div class="card col-lg bg-menoventi1000">
                    <div class="card-body">
                        <div class="cardTitle d-flex align-items-center gap-1 mb-2">
                            ...
                            <h3 class="cl-light text-large">Transport</h3>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="sectionContent col-lg order-lg-2">
                    <span class="pretitle text-small">Customer area</span>
                    <h2 class="text-big mb-4">Login to your account</h2>
                    <p>Unlock a world of convenience with easy access to our dedicated client area. Here you can manage your account, review your services and keep up to date with real-time insights, all at your fingertips.<br><br>

                        Experience a seamless interface designed with your needs in mind, putting you in control and simplifying every aspect of your relationship with us.
                    </p>
