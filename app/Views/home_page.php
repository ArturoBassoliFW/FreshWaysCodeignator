...
<main>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="sectionContent col-lg order-lg-1">
                    <span class="pretitle">Get to know each other</span>
                    <h2>Who are we?</h2>
    ...
    <section class="servicesOffered bg-menoventi100">
        <div class="container">
            <div class="row">
                <span class="pretitle">Discover our services</span>
        ...
        <div class="container">
            <div class="row">
                <div class="sectionImage col-lg order-lg-1 d-flex justify-content-center align-items-center">
                    <img style="width: 60%;" src="<?php echo 'asset/images/svg/portalLogin.svg'; ?>" alt="Login to our customer portal" />
                </div>
                <div class="sectionContent col-lg order-lg-2">
                    <span class="pretitle">Customer area</span>
